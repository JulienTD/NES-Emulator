...
impl CPU {
    pub(crate) fn handleBPL(& mut self, value: u8) -> u8 {
...
mod tests {
    ...
    fn test_bpl_branch_taken() {
        ...
        let cycles = cpu.handleBPL(0x10); // Branch forward by 16
    ...
    fn test_bpl_branch_not_taken() {
        ...
        let cycles = cpu.handleBPL(0x10); // Attempt to branch forward by 16
    ...
    fn test_bpl_page_crossing() {
        ...
        let cycles = cpu.handleBPL(0x20); // Branch forward by 32 (crosses page)
