...
impl CPU {
    pub(crate) fn handle_dop(& mut self, _opt_value: Option<u8>, _opt_address: Option<u16>) -> u8 {
        // NOP does nothing.
        return 0;
    }
}
...
mod tests {
    ...
    fn test_dop_does_nothing() {
        ...
        let cycles = cpu.handle_dop(None, None);

        assert_eq!(cycles, 0, "DOP should not return extra cycles");
